...
-- 确保已先执行 schema.sql 建表

INSERT INTO projects (name, stage, next_action, health, summary, notes) VALUES
(
  '快驴（无锡）',
  '线索',
  '输出夜间（22点-7点）无人车配送费用方案，并寻找快驴总部决策人洽谈合作',
  'yellow',
  '',
  '【客户背景】
...
(
  '无锡天惠超市',
  '线索',
  '评估粮油副食日配方案可行性，输出试用方案（含2个免费试用账号）',
  'yellow',
  '',
  '【客户背景】
无锡天惠超市股份有限公司，本地连锁超市。
